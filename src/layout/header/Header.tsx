        ...
        <div className="nk-header-wrap">
          ...
          <div className="nk-header-app-name">
            ...
            <div className="nk-header-app-info">
              <span className="sub-text">B2B - Deva Yazılım</span>
              <span className="lead-text">Bayi Portalı</span>
            </div>
          </div>
              ...
              <ul className="nk-menu nk-menu-main">
                ...
                >
                  <Link to="/" className="nk-menu-link">
                    <span className="nk-menu-text">Ön İzleme</span>
                  </Link>
                </li>
                <li
                ...
                >
                  <Link to={`/components`} className="nk-menu-link">
                    <span className="nk-menu-text">Araçlar</span>
                  </Link>
                </li>
              </ul>
            </div>
