                    ...
                    <div className="nk-menu-wrap">
                      <ul className="nk-menu-sub">
                        {item.subMenu.map((sItem, sIndex) =>
                          <li key={sIndex} className={classNames({'nk-menu-item': true, 'has-sub' : sItem.subMenu})}>
                              {!sItem.subMenu ? (
                                  ...
                                  <div className="nk-menu-wrap">
                                    <ul className="nk-menu-sub">
                                      {sItem.subMenu.map((s2Item, s2Index) =>
                                        <li key={s2Index} className={classNames({'nk-menu-item': true, 'has-sub' : s2Item.subMenu})}>
                                            {!s2Item.subMenu ? (
                                                ...
                                                <div className="nk-menu-wrap">
                                                  <ul className="nk-menu-sub">
                                                    {s2Item.subMenu.map((s3Item, s3Index) =>
                                                      <li key={s3Index} className="nk-menu-item">
