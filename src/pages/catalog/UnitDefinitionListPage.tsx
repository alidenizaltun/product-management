...
import { UnitDefinitionDto } from "@/domain/types/productOperations.types";
import { useUnitDefinitions, useUnitDefinitionMutations } from "@/application/hooks/useUnitDefinitions";
            ...
            <ConfirmDialog
                ...
                onConfirm={async () => {
                    ...
                    try {
                        ...
                        showSuccess("Birim tanımı silindi.");
