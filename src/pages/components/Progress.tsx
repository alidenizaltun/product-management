...
const ProgressPage = ({ ...props }) => {
    ...
    <React.Fragment>
      ...
      <Content page="component">
        ...
        <Block size="lg">
          ...
          <CodeBlock language="tsx">{`<Progress value="100" />`}</CodeBlock>
        </Block>
        ...
        <Block size="lg">
          ...
          <CodeBlock language="tsx">{`<Progress className="progress-lg" value="80" />`}</CodeBlock>
        </Block>
        ...
        <Block size="lg">
          ...
          <CodeBlock language="tsx">{`<Progress className="progress-lg" value="70"> 70% </Progress>`}</CodeBlock>
        </Block>
        ...
        <Block size="lg">
          ...
          <CodeBlock language="tsx">{`<Progress color="info" value="50" />`}</CodeBlock>
        </Block>
  ...
  <Progress bar color="warning" value="20" />
        ...
        <Block size="lg">
          ...
          <CodeBlock language="tsx">{`<Progress striped color="success" value="25" />`}</CodeBlock>
        </Block>
        ...
        <Block size="lg">
          ...
          <CodeBlock language="tsx">{`<Progress animated value="75" />`}</CodeBlock>
        </Block>
      </Content>
    </React.Fragment>
  );
