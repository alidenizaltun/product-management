    ...
    <React.Fragment>
      ...
      <Content page="component">
        ...
        <Block size="lg">
          ...
          <CodeBlock language="tsx">{`<Spinner color="dark" />`}</CodeBlock>
        </Block>
        ...
        <Block size="lg">
          ...
          <CodeBlock language="tsx">{`<Spinner color="primary" />`}</CodeBlock>
        </Block>
        ...
        <Block size="lg">
          ...
          <CodeBlock language="tsx">{`<Spinner type="grow" color="dark" />`}</CodeBlock>
          <PreviewCard>
            <ul className="preview-list g-2">
              <li className="preview-item">
        ...
        <Block size="lg">
          ...
          <CodeBlock language="tsx">{`<Spinner size="sm" type="grow" />`}</CodeBlock>
          <PreviewCard>
            <ul className="preview-list g-2">
              <li className="preview-item">
          ...
          <CodeBlock language="tsx">{`<Spinner style={{ width: "3rem", height: "3rem" }} type="grow"/>`}</CodeBlock>
        </Block>
