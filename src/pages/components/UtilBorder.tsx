    ...
    <React.Fragment>
      ...
      <Content page="component">
        ...
        <Block size="lg">
          ...
          <CodeBlock language="tsx">{`<div className="border-top"></div>`}</CodeBlock>
        </Block>
        ...
        <Block size="lg">
          ...
          <CodeBlock language="tsx">{`<div className="border-bottom-0"></div>`}</CodeBlock>
        </Block>
        ...
        <Block size="lg">
          ...
          <CodeBlock language="tsx">{`<div className="border border-primary"></div>`}</CodeBlock>
        </Block>
        ...
        <Block size="lg">
          ...
          <CodeBlock language="tsx">{`<div className="rounded-left"></div>`}</CodeBlock>
        </Block>
      </Content>
    </React.Fragment>
  );
