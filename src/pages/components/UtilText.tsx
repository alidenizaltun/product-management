    ...
    <React.Fragment>
      ...
      <Content page="component">
        ...
        <Block size="lg">
          ...
          <CodeBlock language="tsx">{`<span className="text-xl-end">`}</CodeBlock>
        </Block>
        ...
        <Block size="lg">
          ...
          <CodeBlock language="tsx">{`<span className="text-lowercase">`}</CodeBlock>
        </Block>
        ...
        <Block size="lg">
          ...
          <CodeBlock language="tsx">{`<span className="fs-{10}px">`}</CodeBlock>
        </Block>
        ...
        <Block size="lg">
          ...
          <CodeBlock language="tsx">{`<span className="fw-light">`}</CodeBlock>
        </Block>
        ...
        <Block size="lg">
          ...
          <CodeBlock language="tsx">{`<span className="text-break">`}</CodeBlock>
        </Block>
      </Content>
    </React.Fragment>
  );
