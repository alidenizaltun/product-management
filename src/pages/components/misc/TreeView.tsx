          ...
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">
                ...
                easily extendable, themable and configurable, it supports tsx & JSON data sources.
              </p>
              <p className="lead">
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <BlockDes>
                Custom icons can be passed in the <code>tsx markup</code> with each node, use the <code>icon</code>{" "}
                property.
              </BlockDes>
            </BlockHeadContent>
          </BlockHead>
