...
import { useCategories, useSuppliers, useWarehouses } from "@/application/hooks/useCatalog";
import { useInventories, useInventoryReservations } from "@/application/hooks/useInventory";
