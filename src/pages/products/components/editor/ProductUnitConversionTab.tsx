...
import { UnitDefinitionDto, UNIT_ROLE_LABELS, UnitRole } from "@/domain/types/productOperations.types";
...
const ProductUnitConversionTab: React.FC = () => {
    ...
    useEffect(() => {
        unitDefinitionRepository.getAll().then((units: UnitDefinitionDto[]) => {
            setUnitOptions(
                units
                    .filter((u) => u.isActive)
